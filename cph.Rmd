...
So we can say something to the effect of: "The combination of variables for individual A make their hazard rate 1.5x the hazard rate of individual B."  Without more complicated model features, the hazard rates will be proportional.
```{r}
